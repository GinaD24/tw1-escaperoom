...
//        listaDePuestoRankingDTO.add(new PuestoRankingDTO(sala.getId(), partida.getPuntaje(), usuario, partida.getTiempoTotal(), 0 ));
//        listaDePuestoRankingDTO.add(new PuestoRankingDTO(sala.getId(), partida2.getPuntaje(), usuario2, partida2.getTiempoTotal(), 0));
//
//        when(repositorioRanking.obtenerPartidasPorSala(sala.getId())).thenReturn(listaDePartidas);
//
//        List<PuestoRankingDTO> puestosObtenidos = this.servicioRanking.obtenerRankingPorSala(sala.getId());
//
